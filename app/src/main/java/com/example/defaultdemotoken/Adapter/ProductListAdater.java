...
public class ProductListAdater extends RecyclerView.Adapter<ProductListAdater.MyViewHolder> {
    ...
    private void callRemoveFromWishlistApi(String itemid, final int position, final View v, final MyViewHolder holder, final List<Item> itemList) {
        ...
        callRemoveWishlistapi(itemid).enqueue(new Callback<Boolean>() {
            ...
            public void onResponse(Call<Boolean> call, Response<Boolean> response) {
                ...
                if(response.code()==200)
                {
                  ...
                  /*  Bundle b=new Bundle();
                    AppCompatActivity activity = (AppCompatActivity) v.getContext();
                    b.putString("categoryid", ProductListFragment.catid);
